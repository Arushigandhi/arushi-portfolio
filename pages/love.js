      ...
      <div className={styles.aboutContainer}>
        <div className={styles.aboutDescription}>
          <div className={styles.aboutImage}>
            <Image src={one} width={700} height={500} alt="nindhi" />
          </div>
          ...
          <h2>
            ...
            I ever thought we`d get bored of each other. I can`t get enough of
            ...
            Kilimanjaro.
            <br /> <br />
            Missing you always, The hottest bitch you`ll ever fuck 😘
          </h2>
        </div>
      </div>
    </>
